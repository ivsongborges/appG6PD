      ...
      body: Container(
        ...
        child: ListView(children: <Widget>[
          ...
          ListTile(
            ...
            '\n\n Estima-se 400 milhões de pessoas com a doença no mundo e 150 mil novos casos diagnosticados por ano no Brasil. O paciente acometido apresenta uma quantidade reduzida ou não saudável da enzima Glicose-6-Fosfato Desidrogenase, condição que provoca o rompimento dos glóbulos vermelhos em resposta a certos alimentos, medicamentos, infecções ou outros fatores de estresse. \n\n O AppG6PD é um aplicativo de caráter educativo e informativo relacionado a doença hereditária: Deficiência de G6PD (enzima glicose-6-fosfato desidrogenase).'
            ),
          ),
        ]),
      ),
